...
import com.lingling.linglingdating.activitys.ChangePersonActivity;
import com.lingling.linglingdating.activitys.MyAccountActivity;
import com.lingling.linglingdating.activitys.MyTaskActivity;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.image_content_me_more:
                Intent in = new Intent(this,ChangePersonActivity.class);
                startActivityForResult(in, CustomConstants.CHANGE_PER_CODE);
                break;
        }
    }
    @Override
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        super.onActivityResult(requestCode, resultCode, data);
           if(data!=null){
            ...
            }else if(requestCode== CustomConstants.CHANGE_PER_CODE&&resultCode==CustomConstants.CHANGE_PER_BACK){
                txtContentMeMore.setText(data.getStringExtra("con"));
            }
