...
public class ImageChooseActivity extends Activity
{
	...
	private void initListener()
	{
		...
		findViewById(R.id.txt_back_include).setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				finish();
			//	startActivity(new Intent(ImageChooseActivity.this,ShowDataActivity.class));
			}
		});
		findViewById(R.id.image_back_include).setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				finish();
			//	startActivity(new Intent(ImageChooseActivity.this,ShowDataActivity.class));
